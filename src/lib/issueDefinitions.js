...
export const issueDefinitions = [
  ...
  },
  {
    ...
    isResolved: (file) => isYes(file.lineItemQuoteIncluded) || hasText(file.lineItemQuoteExcludedReason),
    onlyIf: (file) => hasText(file.opportunityId),
    resolution: {
      kind: 'toggle',
      key: 'lineItemQuoteIncluded',
      onLabel: 'Confirm BizTrack line-item quote is in the packet',
      offLabel: 'Mark included here, or use Customer Packet to record a reason for excluding it',
      truthyValue: 'true',
